        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Image src="/images/logo/owl-4.svg" alt="DigiTowls" width={28} height={28} />
              <span className="font-body font-bold text-lg">digitowls</span>
            </div>
            <p className="text-sm text-white/50 mb-4">{t("description")}</p>
            <p className="text-sm text-white/50 mb-3">{t("follow_us")}</p>
            <div className="flex items-center gap-3">
              <a
                href="https://www.linkedin.com/company/lafabriquedigitowl"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/lafabriquedigitowl"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/50 hover:text-white transition-colors"
              ...
              <a
                href="https://www.facebook.com/lafabriquedigitowl"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/50 hover:text-white transition-colors"
                aria-label="Facebook"
          ...
          <div>
            <h4 className="font-heading font-bold text-sm mb-4">{t("contact")}</h4>
            <ul className="space-y-2 text-sm text-white/50">
              <li><a href="tel:+14384927832" className="hover:text-white transition-colors">438-492-7832</a></li>
              <li><a href="mailto:candidature@digitowls.com" className="hover:text-white transition-colors">candidature@digitowls.com</a></li>
              <li className="whitespace-pre-line">WeWork, Suite 400{"\n"}3 Place Ville Marie{"\n"}Montréal, H3B 2E3, QC</li>
            </ul>
            <h4 className="font-heading font-bold text-sm mb-4 mt-6">{t("legal")}</h4>
            <ul className="space-y-2 text-sm text-white/50">
              ...
              <li><a href="https://brand.digitowls.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">{t("branding")}</a></li>
            </ul>
          </div>
        </div>
