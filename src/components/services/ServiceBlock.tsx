    ...
    <AnimatedSection>
      <div id={service.id} className={`flex flex-col ${reversed ? "lg:flex-row-reverse" : "lg:flex-row"} gap-8 lg:gap-12 items-start py-16`}>
        <div className="flex-1">
          ...
          <h3 className="text-2xl md:text-3xl font-heading font-bold mb-2">{t("title")}</h3>
          ...
          {t("approach_text") && (
            <p className="text-white/60 mb-3">{t("approach_text")}</p>
          )}
        ...
        <div className="flex-1">
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <h4 className="text-xl font-heading font-bold mb-4">{t("results_title")}</h4>
